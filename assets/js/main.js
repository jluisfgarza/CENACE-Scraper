GDP = {
	config: {
		projectName: "Python-Downloader-CENACE", //Change this by doing GDP.config.projectName = 'foo' before GDP.render()
		userName: "jluisfgarza", //Change this by doing GDP.config.userName = 'bar' before GDP.render()
		rootDir: "data"
	},
