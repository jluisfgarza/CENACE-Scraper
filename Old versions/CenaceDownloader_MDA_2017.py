    ...
    for hour in myrange:
        for minute in myrange:
            for second in myrange:
                ...
                # TESTING LOG print(d)
                url_pml_SIN = "http://www.cenace.gob.mx/DocsMEM/OpeMdo/PreEner/MargLoc/MDA/Dia/5_" + d + "_" + MDA_SIN_d2 + "_SIN_PreciosMargLocalesMDA.csv"
    ...
    for hour in myrange:
        for minute in myrange:
            for second in myrange:
                ...
                global MDA_BCA_d2
                MDA_BCA_d2 = h + "-" + m + "-" + s
                # TESTING LOG  print(MDA_BCA_d2)
                # TESTING LOG print(d)
                url_pml_BCA = "http://www.cenace.gob.mx/DocsMEM/OpeMdo/PreEner/MargLoc/MDA/Dia/5_" + d + "_" + MDA_BCA_d2 + "_BCA_PreciosMargLocalesMDA.csv"
    ...
    for hour in myrange:
        for minute in myrange:
            for second in myrange:
                ...
                global MDA_BCS_d2
                MDA_BCS_d2 = h + "-" + m + "-" + s
                # TESTING LOG  print(MDA_BCS_d2)
                # TESTING LOG print(d)
                url_pml_BCS = "http://www.cenace.gob.mx/DocsMEM/OpeMdo/PreEner/MargLoc/MDA/Dia/5_" + d + "_" + MDA_BCS_d2 + "_BCS_PreciosMargLocalesMDA.csv"
...
def getPND_MDA():
    ...
    url_pnd_SIN = "http://www.cenace.gob.mx/DocsMEM/OpeMdo/PreEner/MargReg/MDA/Dia/26_" + d + "_" + MDA_SIN_d2 + "_SIN_PreciosNodosDistribuidosMDA.csv"
    a = requests.get(url_pnd_SIN)
    if a.status_code == 404:
        print ("ERROR 404 global var MDA_SIN_d2 not working")
        # [15] [09] myrange
        for hour in myrange:
            for minute in myrange:
                for second in myrange:
    ...
    url_pnd_BCA = "http://www.cenace.gob.mx/DocsMEM/OpeMdo/PreEner/MargReg/MDA/Dia/26_" + d + "_" + MDA_BCA_d2 + "_BCA_PreciosNodosDistribuidosMDA.csv"
    a = requests.get(url_pnd_BCA)
    if a.status_code == 404:
        print ("ERROR 404 global var MDA_BCA_d2 not working")
        # [12] [11] myrange
        for hour in myrange:
            for minute in myrange:
                for second in myrange:
    ...
    if a.status_code == 404:
        print ("ERROR 404 global var MDA_BCS_d2 not working")
        # [14] [4] myrange
        for hour in myrange:
            for minute in myrange:
                for second in myrange:
